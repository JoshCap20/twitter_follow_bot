...
# API keys, see readme
client_key: str = "KEY HERE"
client_token: str = "KEY HERE"
access_key = "KEY HERE"
access_token = "KEY HERE"
 
# options
version: int = 1 # available: [1], add more options below
offset: int = 1
...
while run:
    if version == 1:
        # LOGIC FOR BOT, CONFIGURE YOUR OWN 
        ...
        if i == len(accounts) - 1:
            print("Done with current offset.")
            offset += 1
            i = -1
        i += 1
    elif version == 2:
